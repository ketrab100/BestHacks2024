...
class Aspnetusers(models.Model):
    ...
    employee_location = models.TextField(db_column='Employee_Location', blank=True, null=True)  # Field name made lowercase.
    employee_experiencelevel = models.TextField(db_column='Employee_ExperienceLevel', blank=True, null=True)  # Field name made lowercase.
    employee_createdat = models.DateTimeField(db_column='Employee_CreatedAt', blank=True, null=True)  # Field name made lowercase.
    employee_image = models.BinaryField(db_column='Employee_Image', blank=True, null=True)  # Field name made lowercase.
...
class Employertags(models.Model):
    employerid = models.OneToOneField(Aspnetusers, models.DO_NOTHING, db_column='EmployerId', primary_key=True)  # Field name made lowercase. The composite primary key (EmployerId, TagId) found, that is not supported. The first column is selected.
...
class Matches(models.Model):
    id = models.UUIDField(db_column='Id', primary_key=True)  # Field name made lowercase.
    didemployeeacceptjoboffer = models.BooleanField(db_column='DidEmployeeAcceptJobOffer', blank=True, null=True)  # Field name made lowercase.
    didemployeracceptcandidate = models.BooleanField(db_column='DidEmployerAcceptCandidate', blank=True, null=True)  # Field name made lowercase.
    ...
    employerid = models.ForeignKey(Aspnetusers, models.DO_NOTHING, db_column='EmployerId', related_name='matches_employerid_set')  # Field name made lowercase.
...
class Usertags(models.Model):
    userid = models.OneToOneField(Aspnetusers, models.DO_NOTHING, db_column='UserId', primary_key=True)  # Field name made lowercase. The composite primary key (UserId, TagId) found, that is not supported. The first column is selected.
    tagid = models.ForeignKey(Tags, models.DO_NOTHING, db_column='TagId')  # Field name made lowercase.
